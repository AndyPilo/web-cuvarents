...
<div class="container py-5 mt-n3 mt-sm-0 my-xxl-3">
  <div class="row pb-2 pb-sm-3 py-md-4 py-lg-5">
    ...
    <div class="col-md-5 col-lg-6 mb-5 mb-md-0">
      <h1 class="display-5 mb-sm-4">Una manera fácil de encontrar una propiedad perfecta con Cuvarents</h1>
      <p class="pb-3 pb-md-0 mb-4 mb-md-5" style="max-width: 460px">
      En Cuvarents, entendemos que encontrar el hogar de tus sueños puede ser un desafío, pero estamos aquí para simplificar ese proceso y hacerlo más accesible para todos. Nuestra plataforma intuitiva y amigable ofrece una amplia gama de opciones de alquiler, desde acogedores apartamentos en el corazón de La Habana hasta espaciosas casas en las pintorescas provincias de Cuba. Cada propiedad listada ha sido cuidadosamente seleccionada para garantizar que cumple con los más altos estándares de calidad y confort.
<br><br>
Nuestro equipo de expertos en bienes raíces está comprometido a proporcionarte una experiencia de búsqueda sin complicaciones. Utilizando las herramientas de filtrado avanzadas en nuestra página web, puedes buscar propiedades por precio, ubicación (provincias y municipios), y tipo de vivienda, lo que te permite ajustar los resultados a tus necesidades específicas. Ya sea que estés buscando una propiedad para una escapada de fin de semana, unas largas vacaciones, o una residencia de largo plazo, Cuvarents tiene la solución perfecta para ti.
      </p>
