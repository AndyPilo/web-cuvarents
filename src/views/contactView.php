    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
      ...
      <div class="grid lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-1 space-y-8">
          ...
          <div class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-200/50">
            <div class="flex items-center gap-4 mb-6">
              <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500">
              ...
              <div>
                <h3 class="text-lg font-semibold text-gray-900">Llámanos</h3>
                <p class="text-sm text-gray-500">Le atendemos con gusto</p>
              </div>
            </div>
            <a
              id="phoneLink"
              class="block text-2xl font-bold text-cyan-700 hover:text-cyan-800 transition-colors"
              href="#">
              Cargando...
            </a>
          </div>
          ...
          <div class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-200/50">
            <div class="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p class="text-sm text-gray-500">Respondemos lo antes posible</p>
              </div>
            </div>
            <a
              href="mailto:agenciacuvarents@gmail.com"
              class="block text-lg font-medium text-gray-900 hover:text-cyan-700 transition-colors">
          ...
          <div class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-200/50">
            <div class="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p class="text-sm text-gray-500">Soporte continuo</p>
              </div>
            </div>
            <div class="space-y-2">
              <div class="flex justify-between">
                <span class="text-gray-600">Lunes - Domingo</span>
                <span class="font-medium text-gray-900">24:00 h</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-600">Sábado - Domingo</span>
        ...
        <div class="lg:col-span-2">
          <div class="rounded-2xl bg-white p-6 sm:p-8 shadow-xl ring-1 ring-gray-200/50">
            <div class="mb-8">
            ...
            <form id="contactForm" novalidate class="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="block w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900 
                           shadow-sm outline-none transition focus:border-cyan-500 focus:ring-2 
                           focus:ring-cyan-500/30 placeholder:text-gray-400"
              ...
              <div>
                ...
                <textarea
                  ...
                  class="block w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900 
                         shadow-sm outline-none transition focus:border-cyan-500 focus:ring-2 
                         focus:ring-cyan-500/30 resize-none placeholder:text-gray-400"
              ...
              <div class="pt-2">
                <button
                  ...
                  class="group relative w-full sm:w-auto inline-flex items-center justify-center 
                         rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 px-8 py-4 
                         text-base font-semibold text-white shadow-lg transition-all 
                         hover:from-cyan-700 hover:to-blue-700 hover:shadow-xl 
