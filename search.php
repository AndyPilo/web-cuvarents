...
<script>
    ...
    function cargarServicios() {
        fetch('phpgetservices') // Asegúrate de que este archivo PHP devuelve la lista de servicios en formato JSON
