  ...
  <div class="container">
    ...
    <div>
      ...
      <a class="navbar-brand py-1 py-md-2 py-xl-1 me-2 me-sm-n4 me-md-n5 me-lg-0" href="./">
        <span class="me-0">
          <img src="uixsoftware/assets/img/logo-white.png" class="rounded-circle me-2" width="60" alt="Logo blanco de Cuvarents">
        </span>
    ...
    <div class="d-flex gap-sm-1">
      ...
      <div class="d-flex align-items-center gap-2">
        ...
        <?php if (!$loggedIn): ?>
          ...
          <a class="btn buttonx" id="loginBtn" href="auth/login">
            Iniciar sesión
          </a>

          <a class="btn buttons d-none d-md-flex" id="signupBtn" href="auth/signup">
